...
def create_test_data():
    ...
    for tag_data in tags_data:
        ...
        tags.append(tag)
        print(f"{'Created' if created else 'Found'} tag: {tag.tag_name}")
    ...
    for user_data in base_users_data:
        ...
        print(f"{'Created' if created else 'Found'} profile for: {user.username}")
        ...
        print(f"Added tags to profile: {user.username}")
    ...
    for i in range(3, 23):  # user3 to user22
        ...
        if i not in [3, 4, 5]:  # users 3, 4, and 5 will have no tags
            ...
            print(f"Added {num_tags} tags to profile: {user.username}")
        else:
            print(f"Created profile without tags: {user.username}")
    ...
    for name in duplicate_names:
        for i in range(2):  # Create 2 users with each duplicate name
            ...
            if created:
                user.set_password(user_data['password'])
                user.save()
                print(f"Created duplicate name user: {user.username}")
            ...
            print(f"Added {num_tags} tags to duplicate name profile: {user.username}")
    
    print("\nTest data creation completed!")
    print("\nTest users created:")
    print("Base users:")
    print("1. testuser1 (password: testpass123)")
    print("2. testuser2 (password: testpass123)")
    print("\nAdditional users:")
    print("3-22. user3 through user22 (password: testpass123)")
    print("\nEdge case users:")
    print("- Users 3, 4, and 5 have no tags")
    print("- Two users named David Kim")
    print("- Two users named Sarah Park")
